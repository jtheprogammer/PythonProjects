...
def app():
  ...
  image = Image.open('images\LogoRNA.jpeg')
  st.image(image, use_column_width=True, caption='Image credit: https://microbenotes.com/dna-transcription-rna-synthesis/')

  st.header('Enter RNA sequence')
  sequence_input = ">RNA Query \"
  ...
  ***
  ...
  st.header('Segmented RNA Sequence')
  st.markdown(sequence_segments)

  ## DNA nucleotide count
  st.header('RNA Nucleotide Count')

  # function binds nucleotide:count via a dictionary
  def RNA_nucleotide_count(seq):
    r = dict([
              ('A',seq.count('A')),
              ('C',seq.count('C')),
              ('G',seq.count('G')),
  ...
  X = RNA_nucleotide_count(sequence)

   # Total Number of Nucleotide in Input DNA Sequence
  total_nucleotides = X['A'] + X['C'] + X['G'] + X['U']
  ...
  title_colors = {
    ...
    'U': f'<p style="font-family:sans-serif; color:#139487; font-size: 20px;">There are {str(X["U"])}' + ' uracil (U).</p>'
  }
  ...
  st.markdown(title_colors['U'], unsafe_allow_html=True)
  ...
  ***
  ...
  nucleotide_count_list = np.array([X['A'], X['C'], X['G'], X['U']])
  ...
  p2 = alt.Chart(dfp).mark_bar().encode(
      x = 'nucleotide',
      y = alt.Y('%', scale=alt.Scale(domain=(18,32))),
      color = alt.Color('nucleotide')
  )
